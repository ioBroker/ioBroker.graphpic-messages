...
module.exports = function (grunt) {
    ...
    var author    = grunt.option('author') || 'gh-god';
    var email     = grunt.option('email')  || 'mail@mail.com';
    var fs        = require('fs');
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (fs.existsSync(__dirname + '/widgets/gp-msgs/js/gp-msgs.js')) {
            fs.renameSync(__dirname + '/widgets/gp-msgs/js/gp-msgs.js', __dirname + '/widgets/gp-msgs/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/gp-msgs')) {
            fs.renameSync(__dirname + '/widgets/gp-msgs',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Gp-msgs/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Gp-msgs'
                        },
                        {
                            match: /gh-god/g,
                            replacement: author
